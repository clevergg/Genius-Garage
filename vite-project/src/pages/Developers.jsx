    ...
    <div className={styles.card_general}>
        ...
        <div className={styles.card_container}>
            ...
            <div className={styles.card_main}>
                ...
                <hr></hr>
                <span className={styles.spanText}>В 21 году я начал изучать программирование, Но обучение в одиночку не приносило мне удовольствия, что приводило к тому, что я менял направление или вовсе бросал изучение. Так я попробовал себя в Game-dev, Web-dev, а также в дизайне. Но секрет заключался в командной работе. Во время работы над этим проектом я получил то, чего мне не хватало раньше.
                </span>
            </div>
